...
var app = (function (uuid) {
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	const handleSubmit = () => {
    		if (text.trim().length > min) {
    			const newFeedback = { id: uuid.v4(), text, rating: +rating };
    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$3, 16, 4, 387);
    			attr_dev(p, "class", "text-display");
    			add_location(p, file$3, 17, 4, 464);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t0);
    ...
    // (8:4) {#each $FeedbackStore as fb (fb.id)}
    function create_each_block(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			t = space();
    			add_location(div, file$2, 8, 4, 251);
    			this.first = div;
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(8:4) {#each $FeedbackStore as fb (fb.id)}",
    		ctx
    	});
    ...
    class FeedbackList extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$2, create_fragment$2, safe_not_equal, { feedback: 1 });
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 7, 3, 212);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
